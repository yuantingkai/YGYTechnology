...
@implementation WXWithdrawDepositView
...
-(void)setUI{
    ...
    self.accountTextField = [UITextField createTextFieldWithPlace:@"请输入微信账号" withColor:[ColorFormatter hex2Color:0x999999 withAlpha:1]];
    ...
    [accountImageView setImage:[UIImage imageNamed:@"Shape"]];
...
//    self.numTextField.keyboardType = UIKeyboardTypeNumberPad;
    ...
    [numImageView setImage:[UIImage imageNamed:@"wxbi"]];
